/**
 * Terms page SEO tests
 *
 * Ensures all SEO requirements are met for the Terms page:
...
describe("Terms Page SEO", () => {
  describe("Title", () => {
    it("starts with 'Terms of Service'", () => {
      const title = metadata.title as string;
      expect(title).toMatch(/^Terms of Service/);
    });
  ...
  describe("Description", () => {
    ...
    it("mentions Terms of Service", () => {
      const desc = metadata.description as string;
      expect(desc.toLowerCase()).toContain("terms of service");
    });
  ...
  describe("Open Graph", () => {
    ...
    it("has og:image with correct dimensions", () => {
      ...
      if (Array.isArray(images) && images.length > 0) {
        ...
        expect(image.alt).toContain("Terms");
      }
    });
  });
...
describe("Terms Page Structured Data", () => {
